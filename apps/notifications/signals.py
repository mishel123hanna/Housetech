...
def send_notification(sender, instance, created, **kwargs):
    if created:
        ...
        if property_city:
            send_topic_notification(f"location_{property_city}", "New Property Alert", location_message)
        if property_region:
            send_topic_notification(f"location_{property_region}", "New Property Alert", location_message)
